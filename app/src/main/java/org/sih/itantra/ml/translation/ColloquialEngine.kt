...
object ColloquialEngine {
    ...
    private fun formalTamil(text: String): String {
        ...
        val phraseMap = listOf(
            ...
            Pair(Regex("வெட்டிக்கிச்சு|வெட்டிக்கிருச்சு|வெட்டிருச்சு|வெட்டிடுச்சு"), "வெட்டப்பட்டுள்ளது"),
            Pair(Regex("குழம்பிடுச்சு|குழம்பிருச்சு"), "குழம்பியது"),
            Pair(Regex("உடைஞ்சு\\s*போச்சு|உடைஞ்சிருச்சு|உடைஞ்சிடுச்சு"), "உடைந்துள்ளது"),
            Pair(Regex("அடிபட்டுருச்சு|அடிபட்டிடுச்சு"), "காயமடைந்துள்ளது"),
            Pair(Regex("தலை\\s*சுத்துது"), "தலை சுற்றுகிறது"),
            Pair(Regex("ரத்தம்\\s*(?:கொட்டுது|வழியுது)"), "ரத்தம் வழிகிறது"),
            Pair(Regex("வலிக்குது|வலியா\\s*இருக்கு"), "வலியாக உள்ளது"),
            Pair(Regex("மயங்கி\\s*விழுந்துட்டா(?:ரு|ங்க|ன்)"), "மயங்கி விழுந்தார்"),
            Pair(Regex("மயக்கம்\\s*வ(?:ந்துருச்சு|ந்திடுச்சு|ருது)"), "மயக்கமடைந்துள்ளார்")
        )
        ...
        val wordMap = listOf(
            ...
            Pair(wb("வெட்டிக்கிச்சு"), "வெட்டப்பட்டுள்ளது"),
            Pair(wb("குழம்பிடுச்சு"), "குழம்பியது"),
            Pair(wb("குழம்பிருச்சு"), "குழம்பியது"),
            Pair(wb("சுத்துது"), "சுற்றுகிறது"),
            Pair(wb("வலிக்குது"), "வலியாக உள்ளது")
        )
        for ((p, r) in wordMap) {
            t = p.replace(t, r)
        }
