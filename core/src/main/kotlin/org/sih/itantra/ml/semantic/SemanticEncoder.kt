...
class SemanticEncoder {
    ...
    fun encode(
        ...
        val (intent, detectedPriority) = when {
            containsAny(lower, "emergency", "आपातकाल", "அவசரம்", "అత్యవసరం", "ತುರ್ತು", "അടിയന്തരാവസ്ഥ", "জরুরী", "तातडीची", "કટોકટી", "ਐਮਰਜੈਂਸੀ", "injured", "घायल", "காயம்", "గాయపడ్డాడు", "casualties", "हताहत") -> {
                SemanticIntent.EMERGENCY_MEDICAL to Priority.EMERGENCY
            }
            containsAny(lower, "rescue", "trapped", "बचाव", "मीட்பு", "రక్షణ", "രക്ഷാപ്രവർത്തനം", "উদ্ধার", "flood", "बाढ़", "வெள்ளம்", "fire", "आग", "தீ") -> {
